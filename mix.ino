...
void loop() {
  if( ypr[1] * 180/M_PI > -62 && scale.get_units() * 0.453592 < 2 && flag == 0 ){
    deferment();   
  }
  else if( ypr[1] * 180/M_PI < -62 && scale.get_units() * 0.453592 < 2 && flag == 0 ){
    flag = 1;
    Serial.println("낚싯대 거치 완료!");  
    digitalWrite(led1,HIGH);
  }
  else if( ypr[1] * 180/M_PI < -62 && scale.get_units() * 0.453592 < 2 && flag == 1 ){
    flag = 2;
  ...
  else if( ypr[1] * 180/M_PI < -62 && scale.get_units() * 0.453592 < 2 && flag == 2 ){
    detection();  
  }
  ...
  else if( ypr[1] * 180/M_PI < -62 && flag == 3 ){
